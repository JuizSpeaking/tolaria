...
| `mobileWorkspaceEditing.ts` | Pure in-process reducer for note creation, markdown body/title edits, frontmatter scalar properties, favorite/archive flags, relationship add/remove, saved View edits, Type definition metadata/schema edits, and write planning |
